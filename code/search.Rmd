---
# title: "febr -- Busca de Conjuntos de Dados"
# subtitle: "Encontre o conjunto de dados abertos que você precisa para desenvolver seu estudo. Conheça outros conjuntos de dados e veja como estão relacionados ao estudo que você pretende desenvolver."
output: 
  html_document:
    css: style.css
---
...
```{r}
# link <- glue('https://drive.google.com/drive/folders/{sheets_keys$compartilha}')
...
Por favor, sinta-se à vontade para entrar em contato conosco via febr-forum@googlegroups.com. Nós faremos o possível para responder em até 24 horas.
